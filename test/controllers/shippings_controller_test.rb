...
class ShippingsControllerTest < ActionController::TestCase
  ...
  test "should create shipping" do
    assert_difference('Shipping.count') do
      post :create, shipping: { company: @shipping.company, status: @shipping.status, tracking_number: @shipping.tracking_number }
    end
  ...
  test "should update shipping" do
    patch :update, id: @shipping, shipping: { company: @shipping.company, status: @shipping.status, tracking_number: @shipping.tracking_number }
    assert_redirected_to shipping_path(assigns(:shipping))
  end
